              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}>
                <Card className="border-0 playful-shadow bg-gradient-to-br from-blue-50 to-purple-50 hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-6 text-center">
                    ...
                    <div className="text-3xl font-extrabold text-purple-600">{formatNumber('1,250')}</div>
                    <div className="text-sm font-bold text-gray-600 uppercase tracking-wide mt-1">{t.totalStars}</div>
                  </CardContent>
                </Card>
              </motion.div>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
                <Card className="border-0 playful-shadow bg-gradient-to-br from-green-50 to-teal-50 hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-6 text-center">
                    ...
                    <div className="text-3xl font-extrabold text-green-600">{formatNumber(15)}</div>
                    <div className="text-sm font-bold text-gray-600 uppercase tracking-wide mt-1">{t.badges}</div>
                  </CardContent>
                </Card>
              </motion.div>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }}>
                <Card className="border-0 playful-shadow bg-gradient-to-br from-orange-50 to-pink-50 hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-6 text-center">
                    ...
                    <div className="text-3xl font-extrabold text-orange-600">{formatNumber(45)}</div>
                    <div className="text-sm font-bold text-gray-600 uppercase tracking-wide mt-1">{t.hours}</div>
                  </CardContent>
                </Card>
              </motion.div>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }}>
                <Card className="border-0 playful-shadow bg-gradient-to-br from-purple-50 to-blue-50 hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-6 text-center">
                    ...
                    <div className="text-3xl font-extrabold text-blue-600">{formatNumber('89%')}</div>
                    <div className="text-sm font-bold text-gray-600 uppercase tracking-wide mt-1">{t.accuracy}</div>
                  </CardContent>
                </Card>
              </motion.div>
            </div>
              ...
              <Card className="border-0 playful-shadow bg-white/90 backdrop-blur-sm">
                <CardHeader>
                  <CardTitle className="flex items-center space-x-3">
                    ...
                    <span className="text-2xl font-bold">{t.subjectProgress}</span>
                ...
                <CardContent className="space-y-8 pb-8">
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="font-bold text-gray-700 text-lg flex items-center gap-2"><span>🔢</span> {t.math}</span>
                      <span className="text-lg font-extrabold text-blue-600">{formatNumber('85%')}</span>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="font-bold text-gray-700 text-lg flex items-center gap-2"><span>📖</span> {t.english}</span>
                      <span className="text-lg font-extrabold text-green-600">{formatNumber('72%')}</span>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="font-bold text-gray-700 text-lg flex items-center gap-2"><span>🇧🇩</span> {t.bangla}</span>
                      <span className="text-lg font-extrabold text-orange-500">{formatNumber('90%')}</span>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="font-bold text-gray-700 text-lg flex items-center gap-2"><span>🔬</span> {t.science}</span>
                      <span className="text-lg font-extrabold text-purple-600">{formatNumber('67%')}</span>
                    </div>
          ...
          >
            ...
            <Card className="border-0 playful-shadow bg-white/90 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="flex items-center space-x-3">
                  ...
                  <span className="text-2xl font-bold">{t.recentAchievements}</span>
                  <span className="text-3xl animate-bounce-gentle">🎉</span>
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl border border-yellow-100 hover:scale-105 transition-transform cursor-pointer">
                  ...
                  <div>
                    <div className="font-bold text-lg text-gray-800">{t.mathMaster}</div>
                    <div className="text-sm font-medium text-gray-600">{t.mathMasterDesc}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl border border-green-100 hover:scale-105 transition-transform cursor-pointer">
                  <div className="text-4xl">📚</div>
                  <div>
                    <div className="font-bold text-lg text-gray-800">{t.bookworm}</div>
                    <div className="text-sm font-medium text-gray-600">{t.bookwormDesc}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl border border-purple-100 hover:scale-105 transition-transform cursor-pointer">
                  <div className="text-4xl">⭐</div>
                  <div>
                    <div className="font-bold text-lg text-gray-800">{t.starCollector}</div>
                    <div className="text-sm font-medium text-gray-600">{t.starCollectorDesc}</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 playful-shadow bg-gradient-to-br from-orange-400 to-pink-500 text-white transform hover:-translate-y-2 transition-transform duration-300">
              <CardContent className="p-8 text-center relative overflow-hidden">
                ...
                <div className="text-5xl font-extrabold mb-2 relative z-10 drop-shadow-md">{formatNumber(7)} {isBn ? 'দিন' : 'Days'}</div>
                <div className="text-xl font-bold opacity-90 uppercase tracking-widest relative z-10">{t.learningStreak}</div>
                <div className="text-sm opacity-80 mt-3 font-medium relative z-10">{t.keepItUpSuperstar}</div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 playful-shadow bg-white/90 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="flex items-center space-x-3">
                  ...
                  <span className="text-2xl font-bold">{t.nextGoal}</span>
                  <span className="text-3xl animate-bounce-gentle">🎯</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-center space-y-5 p-6 bg-gray-50 rounded-2xl border border-gray-100">
                  <div className="text-xl font-bold text-gray-800">{t.complete10Science}</div>
                  <div className="text-5xl animate-float">🧪</div>
                  <div className="space-y-3 w-full">
                    <div className="flex justify-between text-base font-bold text-gray-700">
                      <span>{t.progress}</span>
                      <span className="text-green-600">{formatNumber('6/10')}</span>
                    </div>
                    <Progress value={60} className="h-3 bg-green-100 [&>div]:bg-green-500" />
                  </div>
                  <div className="text-base font-medium text-purple-600 bg-purple-50 inline-block px-4 py-2 rounded-full">{t.only4More}</div>
                </div>
              </CardContent>
            </Card>
          </motion.div>
