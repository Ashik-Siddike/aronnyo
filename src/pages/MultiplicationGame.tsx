...
const MultiplicationGame = () => {
  ...
  const generateOptions = (correctAnswer: number) => {
    ...
    while (optionsSet.size < 4) {
      let randomOption;
      if (correctAnswer <= 10) {
        randomOption = Math.floor(Math.random() * 15) + 1; // 1-15 for small numbers
      } else if (correctAnswer >= 30) {
        randomOption = Math.floor(Math.random() * 20) + (correctAnswer - 10); // around correct answer
      } else {
        randomOption = Math.floor(Math.random() * 40) + 1; // 1-40 for middle numbers
      }
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              <h1 className="text-3xl font-bold mb-2 animate-bounce-gentle">✖️ গুণ কুইজ</h1>
              <p className="text-lg opacity-90">সংখ্যা গুণ করে সঠিক উত্তর দিন!</p>
            </div>
            ...
            <CardContent className="p-8">
              <div className="text-center space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-3xl p-8 animate-scale-in">
                    <div className="text-6xl lg:text-8xl font-bold text-gray-800 space-y-4">
                      <div className="flex items-center justify-center space-x-4">
                        ...
                        <span className="text-blue-600 animate-wiggle">?</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="text-center space-y-2 animate-fade-in delay-500">
                  ...
                  <p className="text-lg text-gray-600 font-medium">
                    তুমি দারুণ করছো! গুণ করতে থাকো আর শিখতে থাকো!
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="max-w-2xl mx-auto border-0 playful-shadow animate-fade-in">
            <CardContent className="p-8 text-center space-y-6">
              ...
              <p className="text-xl text-gray-600">
                অসাধারণ! তুমি সব গুণের প্রশ্নের উত্তর দিয়েছো।
              </p>
              
              <div className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-2xl p-6 space-y-4">
                <h3 className="text-2xl font-bold text-purple-800">তোমার ফলাফল:</h3>
              ...
              <div className="space-y-4">
                <Button
                  onClick={resetGame}
                  size="lg"
                  className="w-full bg-purple-500 hover:bg-purple-600 text-white text-lg px-8 py-3 rounded-xl transition-colors duration-200"
                >
